...
function NavLinks() {
	...
	return (
		<div className=' sticky bg-[#333333] opacity-95 z-50 top-0 flex items-center justify-between'>
			...
			{isMenuVisible ? (
				<div className='menu absolute right-0 top-0 bg-[#333333] h-screen flex flex-col items-center w-1/2  pt-3'>
					<div
					...
					<ul className='  px-4 py-2 flex flex-col-reverse justify-evenly items-center h-1/2'>
						<Link to='/'>
							{' '}
